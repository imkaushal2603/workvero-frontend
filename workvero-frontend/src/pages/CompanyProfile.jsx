...
function CompanyProfile() {
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                ...
                const hasCompletedProfile = res.data.company?.companyName && res.data.company?.email && res.data.company?.phone;
                if (!hasCompletedProfile) {
                    navigate("/employer/profile/edit", { state: { company: res.data.company } });
                    return;
                }
    ...
    return (
        <>
            {loading && <Loader />}
            <div className={`company-profile-container ${loading ? "loading" : ""}`}>
                ...
                <div className="profile-card">
                    ...
                    <div className="profile-header">
                        <div className="profile-picture-container">
                            ...
                            <button onClick={() => navigate('/employer/profile/edit')} className="edit-btn">Edit Profile</button>
                        </div>
