            ...
            <div className="content-wrapper">
                <div className="dashboard_header_section">
                    ...
                    <div className="dashboard_header_content">
                        <div className="dashboard_header_notifications" ref={notifRef}>
                                        ...
                                        <>
                                            {notifications.map((item) => {
                                                ...
                                                if (userRole === 'recruiter') {
                                                    ...
                                                    return (
                                                        <div key={item.id} className={`notification_item${isUnread ? ' unread' : ''}`} onClick={() => handleNotificationClick(item)}>
                                                            <h6>{candidate?.firstName} {candidate?.lastName}</h6>
                                                            <p>{item.appliedJobs?.[0]?.jobTitle}</p>
                                                        </div>
                                                    );
                                                }
                                                const jobTitle = item.jobs?.title;
                                            ...
                                            <div className='notification_view_more'>
                        ...
                        <div className="account_dropdown" ref={accountRef}>
                            <button
