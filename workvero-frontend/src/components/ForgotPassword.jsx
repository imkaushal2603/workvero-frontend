...
function ForgotPassword({ isOpen, onClose, onSwitchToLogin }) {
    ...
    return (
        <div className="auth_modal_overlay forgot_password">
            <div className="auth_modal_content" onClick={(e) => e.stopPropagation()}>
                ...
                <form onSubmit={(e) => e.preventDefault()}>
                    ...
                    <button type="submit" className="login_submit_btn">Get New Password</button>
                </form>
                <p className="switch_auth_text">
                    Remember your password? <span onClick={onSwitchToLogin}>Login</span>
                </p>
            </div>
        </div>
    );
